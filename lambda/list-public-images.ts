...
export const handler = async (): Promise<APIGatewayProxyResult> => {
  try {
    // Query, not Scan: only ever touches items where visibility="public",
    // and ScanIndexForward:false returns them newest-first for free since
    // createdAt is the GSI's sort key.
